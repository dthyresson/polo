...
describe "Poll API GET" do
  ...
  it 'gets a poll with choices' do
  ...
  it 'gets a poll with uncast votes' do
...
describe "Poll API POST" do
  ...
  it "creates a post with 5 voter phone numbers" do
