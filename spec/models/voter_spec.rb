...
describe Voter, "phony_formatted" do
  it "will format a phone number to US style" do
    voter = create(:voter, phone_number: "6175550001")
    expect(voter.phone_number.phony_formatted(:format => :international, :spaces => '-')).to eq("+1-617-555-0001")
  end
end

describe Voter, "formatted_phone_number" do
  it "will format a phone number to US style" do
    voter = create(:voter, phone_number: "6175550001")
    expect(voter.formatted_phone_number).to eq("+1-617-555-0001")
  end
end
